...
Then, we encode constraints on when these new variables are true. When is the first trial congruent? \texttt{5 iff (1 and 3) or (2 and 4)}. We create constraints of this form for all the remaining variables.
